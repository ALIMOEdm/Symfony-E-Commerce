...
use AppBundle\Entity\Extra_fields;
use AppBundle\Form\Extra_fieldsType;
...
class Extra_fieldsController extends Controller
{
    ...
    public function indexAction(Request $request)
    {
        ...
        $query = $em->getRepository('AppBundle:Extra_fields')->getExtraFieldList();
     ...
     * @Method("POST")
     * @Template("AppBundle:Extra_fields:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AppBundle:Extra_fields')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AppBundle:Extra_fields:edit.html.twig")
     */
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            $em->getRepository('AppBundle:Extra_fields')->deleteCategoryExtraFieldsLinks($id);
            $em->getRepository('AppBundle:Extra_fields')->deleteGoodExtraFieldsLinks($id);
            $em->remove($entity);
            $em->flush();
        }
