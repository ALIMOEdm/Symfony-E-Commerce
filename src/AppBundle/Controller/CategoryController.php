...
class CategoryController extends Controller
{
    ...
    public function getParentCategoryEntity($parent_category_id){
        ...
        if(!is_null($parent_category_id) && $parent_category_id){
            $parent_category = $em->getRepository('AppBundle:Category')->find($parent_category_id);
        }
    ...
    public function editAction($id)
    {
        ...
        if ( null !== $entity->getParentCategory() ){
            $entity->setParentCategoryEntity($em->getRepository('AppBundle:Category')->find($entity->getParentCategory()));
        }
    ...
    */
    ...
    protected function deleteTreePaths($id){
        $result = $this->getDoctrine()->getManager()->getRepository('AppBundle:Category')->deleteCategoriesByDescendant($id);
    }
    ...
    protected function handleTreePaths($category_id, $childs){
        foreach ($childs as $child) {
            $em = $this->getDoctrine()->getManager();
            $next_childs = $em->getRepository('AppBundle:Category')->getFirstLineChildsCategory($child['id']);
    ...
    protected function addTreePaths($parent_category, $id){
        ...
        $result = $this->getDoctrine()->getManager()->getRepository('AppBundle:Category')->addCategoryTreePaths($id, $parent_category);
    }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        if ($form->isValid()) {
            ...
            $this->deleteTreePaths($id);
            $em->getRepository('AppBundle:Goods')->updateGoodsCategory($id);
            $em->getRepository('AppBundle:Category')->deleteExtraFieldsLinks($id);
            $em->remove($entity);
            $em->flush();
        }
