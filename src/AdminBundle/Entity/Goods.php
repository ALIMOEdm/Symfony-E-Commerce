...
/**
* @ORM\Entity
* @ORM\Entity(repositoryClass="AdminBundle\Entity\Repository\GoodsRepository")
...
class Goods{
    ...
    */
     ...
     * Add image
     *
     * @param \AdminBundle\Entity\File $image
     *
     * @return Goods
     */
    public function addImage(\AdminBundle\Entity\File $image)
    {
        $this->images[] = $image;
     ...
     * @param \AdminBundle\Entity\File $image
     */
    public function removeImage(\AdminBundle\Entity\File $image)
    {
     ...
     * Add extraField
     *
     * @param \AdminBundle\Entity\GoodExtraField $extraField
     *
     * @return Goods
     */
    public function addExtraField(\AdminBundle\Entity\GoodExtraField $extraField)
    {
     ...
     * @param \AdminBundle\Entity\GoodExtraField $extraField
     */
    public function removeExtraField(\AdminBundle\Entity\GoodExtraField $extraField)
    {
