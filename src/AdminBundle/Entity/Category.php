...
class Category{
    ...
    */
     ...
     * Add extraField
     *
     * @param \AdminBundle\Entity\Extra_fields $extraField
     *
     * @return Category
     */
    public function addExtraField(\AdminBundle\Entity\Extra_fields $extraField)
    {
     ...
     * @param \AdminBundle\Entity\Extra_fields $extraField
     */
    public function removeExtraField(\AdminBundle\Entity\Extra_fields $extraField)
    {
     ...
     * Add good
     *
     * @param \AdminBundle\Entity\Goods $good
     *
     * @return Category
     */
    public function addGood(\AdminBundle\Entity\Goods $good)
    {
        $this->goods[] = $good;
     ...
     * @param \AdminBundle\Entity\Goods $good
     */
    public function removeGood(\AdminBundle\Entity\Goods $good)
    {
