...
class XmlEngineController extends Controller {
    ...
    public function downloadAction(){
        ...
        while (true){
            $goods = $em->getRepository('AdminBundle:Goods')->getGoodSet($limit, $offset);
            ...
            foreach ($goods as $good){
                ...
                $propertes = $em->getRepository('AdminBundle:GoodExtraField')->getExtraFiledsByGoodId($good['id']);
                if(count($propertes)){
     ...
     * @Template("AdminBundle:Xml:uploadXml.html.twig")
     */
        ...
        if ($form->isValid()) {
            ...
            if(count($goods)){
                foreach ($goods as $good){
                    ...
                    if($xml_title){
                        $good_ent = $em->getRepository('AdminBundle:Goods')->findOneBy(array('xml_title'=>$xml_title));
                    }
...
//                        $good_ent = new Goods();
                    ...
                    $category_obj = $em->getRepository('AdminBundle:Category')->findOneBy(array('xml_title'=>$category_xml_title));
                        ...
                        switch (strtolower($child->nodeName)){
                            ...
                            case 'extra_fields':
                                ...
                                foreach ($child->childNodes as $extra_field){
                                    ...
                                    $extra_field_obj = $em->getRepository('AdminBundle:Extra_fields')->findOneBy(array('xml_title'=>$xml_title_str));
